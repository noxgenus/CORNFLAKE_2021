...
#ifndef _ANDERSMMG_TFTLCD_H_
#define _ANDERSMMG_TFTLCD_H_
...
//#define USE_ANDERSMMG_SHIELD_PINOUT 1

class Andersmmg_TFTLCD : public Adafruit_GFX {
  
 public:

  Andersmmg_TFTLCD(uint8_t cs, uint8_t cd, uint8_t wr, uint8_t rd, uint8_t rst);
  Andersmmg_TFTLCD(void);
...
#ifndef USE_ANDERSMMG_SHIELD_PINOUT
